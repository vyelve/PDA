...
namespace PDA.Web.Filters
{
    public class DecryptQueryStringParameterAttribute : ActionFilterAttribute
    {
        public override void OnActionExecuting(ActionExecutingContext filterContext)
        {
            try
            {
                var dataProtectionProvider = DataProtectionProvider.Create("PDA.Web");
                var protector = dataProtectionProvider.CreateProtector("PDA.Web.QueryStrings");
